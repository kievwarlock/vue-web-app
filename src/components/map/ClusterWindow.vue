<template>
    <div class="cluster-window" v-show="markers.length > 0">
        ...
        <transition name="fade">
            <div class="info-windows-head loader-content" v-show="loading">
                Loading...
            </div>
        </transition>

        <transition name="fade">
            <div class="marker-info-window-slider" v-if="!loading && markersData.length > 0">
                    ...
                    <swiper-slide v-for="sliderItem of markersData">
                        ...
                        <div class="marker-info-window-inner">
                            <div class="marker-info-window-avatar">
                                <img :src="sliderItem.avatar" v-if="sliderItem.avatar"
                                     class="marker-info-window-avatar-image" alt="">
                            </div>
                            <div class="marker-info-window-user">

                                <p><strong>{{sliderItem.fullName}}</strong></p>
                ...
                <div class="window-info-bottom" v-if="markersData.length > 1 && markers.length >= maxDataSize">
...
<style>
    ...
    .marker-info-window-avatar {
        ...
        margin: 0px auto;
        border-radius: 10px;
        background: url('../../assets/avatar-placeholder.png') no-repeat center;
        background-size: cover;
    }
